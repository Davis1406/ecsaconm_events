...
async def add_user(
    ...
    return {**user_schema.model_dump(), "id": create_user_model.id}
        ...
        "profile": (
            {
                ...
                "designation": user.user_profile[0].designation,
                "certificate_name": user.user_profile[0].certificate_name,
                "address": user.user_profile[0].address,
            }
...
async def add_or_update_profile(
    ...
    if profile_model:
        ...
        profile_model.designation = profile_schema.designation
        profile_model.certificate_name = profile_schema.certificate_name
        profile_model.address = profile_schema.address
    else:
        # Create new profile
        profile_model = UserProfile(
            ...
            designation=profile_schema.designation,
            certificate_name=profile_schema.certificate_name,
            address=profile_schema.address,
        )
